...
@EnableNeo4jRepositories(basePackages = "com.eminyidle.checklist.adapter.out.persistence",transactionManagerRef = "neo4jTransactionManager")
public class Neo4jConfig extends Neo4jAutoConfiguration {

    @Value("${CHECKLIST_NEO4J_URI}")
    private String neo4jUri;
    @Value("${CHECKLIST_NEO4J_USER_NAME}")
    private String username;
    @Value("${CHECKLIST_NEO4J_USER_PASSWORD}")
