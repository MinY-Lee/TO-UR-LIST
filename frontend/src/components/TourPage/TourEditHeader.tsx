...
import { editCity, editPeriod, editTitle, getCity, getCountry } from '../../util/api/tour';
...
export default function TourEditHeader(props: PropType) {
    ...
    const handleQuery = (data: string) => {
        ...
        if (foundCountry) {
            ...
            const targetCountry = countryList.find((country) => country.countryCode === foundCountry.countryCode);
