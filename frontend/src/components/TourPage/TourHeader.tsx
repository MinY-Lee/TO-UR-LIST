        ...
        <div>
            ...
            <div className="w-full grid grid-cols-6 justify-between items-end p-5 bak">
                ...
                <div ref={dropdownRef} className="flex justify-center" onClick={() => setIsClicked(!isClicked)}>
                    ...
                    <div id="dropdown" className={`${setDropdown(isClicked)} absolute top-[25%] right-[10%] z-10 bg-white divide-y divide-gray-100 rounded-lg shadow`}>
                    
                    <ul className=" text-gray-700" aria-labelledby="dropdown-button">
                        <li className="hover:bg-[#94cef2] py-2 px-5 rounded-t-lg border" onClick={() => handleTypeChange("edit")}>
                        ...
                        <li className="hover:bg-[#94cef2] px-5 py-2 rounded-b-lg border" onClick={() => handleTypeChange("out")}>
                            <div className="flex gap-2 items-center">
                        ...
                        <li className="hover:bg-[#94cef2] px-5 py-2 rounded-b-lg border " onClick={() => handleTypeChange("delete")}>
                            <div className="flex gap-2 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
