...
export default function PlaceSearchCard(props: PropType) {
    ...
    return (
        <div className="w-full h-38vw flex justify-center items-center flex-shrink-0 p-vw">
            <div
                className="w-[95%] p-2vw h-full color-border-blue-2 border-halfvw border-rad-2vw flex flex-col"
            ...
            >
                <div className="w-full h-[30%] flex justify-between items-center">
                    ...
                    {props.visitedCache.has(props.placeInfo.placeId) ? (
                        //이미 있는 장소면 추가됨
                        <div
                            className="w-[20%] h-7vw text-4vw border-rad-3vw bg-white color-text-blue-2 color-border-blue-2 border-halfvw flex justify-center items-center"
                            onClick={(event) => {
                                //여행 삭제
                                if (wsClient) {
                        ...
                        <div
                            className="w-[20%] h-7vw text-4vw border-rad-3vw color-bg-blue-2 text-white flex justify-center items-center"
                            onClick={(event) => {
                                //추가하는 요청 전송
                                if (wsClient) {
                                    props.setIsLoading(true);
