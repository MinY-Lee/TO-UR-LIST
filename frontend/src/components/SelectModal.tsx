...
export default function SelectModal(props: Proptype) {
    ...
    return (
        <>
            ...
            <div
                className="absolute rounded-2xl w-[90%] h-[70%] left-[5%] top-[15%] z-30 bg-white grid grid-rows-10 p-5 border-[0.5vw] color-border-blue-2"
            ...
            >
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <div key={index} className=" grid grid-cols-3 justify-center m-1">
                                            <div className="flex items-center col-span-2">
                                                ...
                                                />
                                                <label className="ms-2 text-lg w-[70%] overflow-ellipsis overflow-hidden whitespace-nowrap">{item.activity}</label>
                                            </div>
                                        </div>
                                        ))}
                                    </div>
                ...
                <div className="row-span-1 grid grid-cols-2 justify-center p-3 gap-2"> 
                    <MyButton isSelected={true} onClick={props.clickOK} text="저장" type="full" className="py-2"></MyButton>
