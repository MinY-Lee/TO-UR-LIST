                                    ...
                                    <div className='ml-5 mt-3' key={index}>
                                        ...
                                        <div>
                                            ...
                                            <div key={index} className=" grid grid-cols-3 justify-center m-1">
                                                ...
                                                <div onClick={() => {handleDeleteModal(item)}} className="flex justify-end mr-2 items-center">
                                            ...
                                            { isAddState[day]
                                                ? <ChecklistInput className="px-[3%]" tourId={tourId} checklistPerDay={groupedItems} tourDay={day} placeId={placeId} onUpdate={onUpdate}/>
                                                : <div onClick={() => handleAddState(day)} className="ml-3 mt-1 underline text-neutral-400">+ 항목추가</div>
                                            }
                                        </div>
