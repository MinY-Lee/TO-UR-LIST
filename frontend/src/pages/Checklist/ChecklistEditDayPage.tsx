...
export default function ChecklistEditDayPage() {
    ...
    const handleDelete = () => {
        if (groupedItems && deleteItem) {
            // 데이터 삭제 api
            const updatedChecklist = groupedItems[deleteItem?.tourDay][deleteItem?.placeId].filter(
